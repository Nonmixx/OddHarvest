...
const contentMap: Record<string, Record<Language, string>> = {
  ...
  "Ladang Pisang, Cameron Highlands": { en: "Ladang Pisang, Cameron Highlands", zh: "香蕉农场，金马仑高原", ms: "Ladang Pisang, Cameron Highlands" },
  ...
  "Bananas (3kg)": { en: "Bananas (3kg)", zh: "香蕉（3公斤）", ms: "Pisang (3kg)" },
  "Spinach (2kg)": { en: "Spinach (2kg)", zh: "菠菜（2公斤）", ms: "Bayam (2kg)" },
  "Spinach (4kg)": { en: "Spinach (4kg)", zh: "菠菜（4公斤）", ms: "Bayam (4kg)" },
  "Tomatoes (2kg)": { en: "Tomatoes (2kg)", zh: "番茄（2公斤）", ms: "Tomato (2kg)" },
  "Carrots (1kg)": { en: "Carrots (1kg)", zh: "胡萝卜（1公斤）", ms: "Lobak Merah (1kg)" },
  "Carrots (2kg)": { en: "Carrots (2kg)", zh: "胡萝卜（2公斤）", ms: "Lobak Merah (2kg)" },
  "Tomatoes (8kg)": { en: "Tomatoes (8kg)", zh: "番茄（8公斤）", ms: "Tomato (8kg)" },
  "Chillies (2kg)": { en: "Chillies (2kg)", zh: "辣椒（2公斤）", ms: "Cili (2kg)" },

  // Driver locations
  "Petaling Street, Kuala Lumpur": { en: "Petaling Street, Kuala Lumpur", zh: "茨厂街，吉隆坡", ms: "Jalan Petaling, Kuala Lumpur" },
  "Pasar Seni, Kuala Lumpur": { en: "Pasar Seni, Kuala Lumpur", zh: "中央艺术坊（Pasar Seni），吉隆坡", ms: "Pasar Seni, Kuala Lumpur" },
  "KL Sentral, Kuala Lumpur": { en: "KL Sentral, Kuala Lumpur", zh: "吉隆坡中环（KL Sentral），吉隆坡", ms: "KL Sentral, Kuala Lumpur" },
  "KLCC, Kuala Lumpur": { en: "KLCC, Kuala Lumpur", zh: "吉隆坡城中城（KLCC），吉隆坡", ms: "KLCC, Kuala Lumpur" },
  "Bukit Bintang, Kuala Lumpur": { en: "Bukit Bintang, Kuala Lumpur", zh: "武吉免登，吉隆坡", ms: "Bukit Bintang, Kuala Lumpur" },
  "Bangsar, Kuala Lumpur": { en: "Bangsar, Kuala Lumpur", zh: "孟沙，吉隆坡", ms: "Bangsar, Kuala Lumpur" },
  "Sri Petaling, Kuala Lumpur": { en: "Sri Petaling, Kuala Lumpur", zh: "大城堡（Sri Petaling），吉隆坡", ms: "Sri Petaling, Kuala Lumpur" },
  "Tanah Rata Town Centre, Cameron Highlands": { en: "Tanah Rata Town Centre, Cameron Highlands", zh: "丹那拉打镇中心，金马仑高原", ms: "Pusat Bandar Tanah Rata, Cameron Highlands" },
  "Brinchang, Cameron Highlands": { en: "Brinchang, Cameron Highlands", zh: "碧兰璋，金马仑高原", ms: "Brinchang, Cameron Highlands" },
  "Ringlet, Cameron Highlands": { en: "Ringlet, Cameron Highlands", zh: "冷力，金马仑高原", ms: "Ringlet, Cameron Highlands" },
  "Chow Kit Wet Market, Kuala Lumpur": { en: "Chow Kit Wet Market, Kuala Lumpur", zh: "秋杰湿货市场，吉隆坡", ms: "Pasar Basah Chow Kit, Kuala Lumpur" },
  "Wangsa Maju, Kuala Lumpur": { en: "Wangsa Maju, Kuala Lumpur", zh: "旺沙玛珠，吉隆坡", ms: "Wangsa Maju, Kuala Lumpur" },
  "Seri Kembangan Town Centre, Selangor": { en: "Seri Kembangan Town Centre, Selangor", zh: "史里肯邦安镇中心，雪兰莪", ms: "Pusat Bandar Seri Kembangan, Selangor" },
  "Kuantan City Centre, Pahang": { en: "Kuantan City Centre, Pahang", zh: "关丹市中心，彭亨", ms: "Pusat Bandar Kuantan, Pahang" },
  "Beserah, Kuantan": { en: "Beserah, Kuantan", zh: "百色拉，关丹", ms: "Beserah, Kuantan" },
