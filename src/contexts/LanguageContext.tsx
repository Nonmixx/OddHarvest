...
const translations: Record<string, Record<Language, string>> = {
  ...
  "market.location_title": { en: "Enable Location", zh: "启用定位", ms: "Dayakan Lokasi" },
  "market.location_desc": { en: "We use your location to show nearby farms and more realistic delivery distances.", zh: "我们使用您的位置来显示附近农场和更真实的配送距离。", ms: "Kami menggunakan lokasi anda untuk memaparkan ladang berdekatan dan jarak penghantaran yang lebih realistik." },
  "market.enable_location": { en: "Allow Location", zh: "允许定位", ms: "Benarkan Lokasi" },
  "market.location_denied": { en: "Permission denied in browser settings.", zh: "浏览器设置中已拒绝权限。", ms: "Kebenaran ditolak dalam tetapan pelayar." },
  "market.location_locating": { en: "Getting your location…", zh: "正在获取您的位置…", ms: "Mendapatkan lokasi anda…" },
  "market.location_gps_unavailable": { en: "Could not get a precise fix. Try outdoors or check GPS is on.", zh: "无法精确定位。请到户外或检查 GPS 是否开启。", ms: "Tidak dapat lokasi tepat. Cuba di luar atau pastikan GPS dihidupkan." },
  "market.location_https": { en: "Location requires HTTPS. Open the app using https://", zh: "定位需要 HTTPS，请使用 https:// 打开应用。", ms: "Lokasi memerlukan HTTPS. Buka aplikasi dengan https://" },
  ...
  "farmer.rescue_alert": { en: "This crop is not selling quickly", zh: "这个农产品销售缓慢", ms: "Tanaman ini tidak terjual dengan cepat" },
  "farmer.rescue_tip_price": { en: "Reduce price to attract buyers", zh: "降低价格以吸引买家", ms: "Kurangkan harga untuk menarik pembeli" },
  "farmer.rescue_tip_bundle": { en: "Convert into a bundle deal", zh: "转换为套装优惠", ms: "Tukar kepada tawaran bundle" },
  "farmer.rescue_tip_urgent": { en: "Mark as urgent to boost visibility", zh: "标记为紧急以提高曝光", ms: "Tandai sebagai segera untuk tingkatkan keterlihatan" },
  "farmer.rescue_listed_long": { en: "Listed for a while", zh: "已上架一段时间", ms: "Disenarai agak lama" },
  "farmer.rescue_low_stock_move": { en: "Low purchase activity", zh: "购买活动少", ms: "Aktiviti pembelian rendah" },
  ...
  "profile.payout_details": { en: "Payout / Bank Details", zh: "收款 / 银行信息", ms: "Butiran Pembayaran / Bank" },
  "profile.saved_account": { en: "Saved account", zh: "已保存账户", ms: "Akaun disimpan" },
  "profile.bank_name": { en: "Bank Name", zh: "银行名称", ms: "Nama Bank" },
  "profile.bank_name_placeholder": { en: "e.g. Maybank", zh: "例如 Maybank", ms: "cth. Maybank" },
  "profile.account_holder": { en: "Account Holder Name", zh: "账户持有人姓名", ms: "Nama Pemegang Akaun" },
  "profile.account_holder_placeholder": { en: "e.g. Ahmad Rizal", zh: "例如 Ahmad Rizal", ms: "cth. Ahmad Rizal" },
  "profile.account_number": { en: "Account Number", zh: "账号", ms: "Nombor Akaun" },
  "profile.account_number_placeholder": { en: "Numbers only", zh: "仅限数字", ms: "Nombor sahaja" },
  "profile.bank_hint": { en: "Fill all fields if you want to receive payouts. Account number must be 6–20 digits.", zh: "如需收款请填写完整信息。账号需为 6–20 位数字。", ms: "Isi semua medan untuk menerima pembayaran. Nombor akaun mesti 6–20 digit." },
  "profile.bank_required": { en: "Please fill bank name, account holder and account number.", zh: "请填写银行名称、账户持有人姓名与账号。", ms: "Sila isi nama bank, pemegang akaun dan nombor akaun." },
  "profile.bank_invalid_account": { en: "Account number must be 6–20 digits (numbers only).", zh: "账号必须为 6–20 位数字（仅限数字）。", ms: "Nombor akaun mesti 6–20 digit (nombor sahaja)." },
