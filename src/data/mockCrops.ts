...
export const mockCrops: CropListing[] = [
  ...
  },
  {
    ...
    sellerId: "seller-4",
    sellerType: "community",
    description: "Home-grown cherry tomatoes, slightly irregular but bursting with flavor.",
    harvestDate: new Date(Date.now() - 0.5 * 24 * 60 * 60 * 1000).toISOString(),
    distanceKm: 5,
    imperfectReason: "irregular_shape",
  },
  {
    ...
    sellerId: "seller-5",
    sellerType: "community",
    description: "Spicy chili padi grown in the backyard. Some are curved but full of heat!",
    harvestDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    distanceKm: 8,
    imperfectReason: "irregular_shape",
  },
  ...
  },
  {
    ...
    sellerId: "seller-4",
    sellerType: "community",
    description: "A mix of home-grown herbs and veggies from Sarah's garden.",
    harvestDate: new Date(Date.now() - 0.5 * 24 * 60 * 60 * 1000).toISOString(),
    distanceKm: 5,
    imperfectReason: "too_small",
    isBundle: true,
